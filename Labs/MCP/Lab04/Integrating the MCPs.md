...
"Multiply2Numbers": {
	...
	"args": [
		"env",
		"python3",
		"/home/<homedir>/CiscoLive202_VibeOpsLounge/Lab01/server.py"
	],
},
"subnet-calculator": {
	"type": "stdio",
	...
	"args": [
		"env",
		"python3",
	    "/home/<homedir>/CiscoLive202_VibeOpsLounge/Lab02/server.py"
	],
},
"pyats": {
	"type": "stdio",
	...
	"args": [
		"env",
		"PYATS_TESTBED_PATH=/home/<homedir>/CiscoLive202_VibeOpsLounge/Lab03/testbed.yaml",
		"python3",
		"/home/<homedir>/CiscoLive202_VibeOpsLounge/Lab03/server.py"
	]
}    
